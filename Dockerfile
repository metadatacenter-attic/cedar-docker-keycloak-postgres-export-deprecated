...
CMD ["-b", "0.0.0.0", "-Dkeycloak.migration.action=export -Dkeycloak.migration.provider=singleFile -Dkeycloak.migration.file=/export/cedar.metadatacenter.orgx.json -Dkeycloak.migration.realmName=CEDAR"]